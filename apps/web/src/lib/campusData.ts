...
export const BUILDINGS: Building[] = [
  ...
  },
  {
    ...
    w: 140,
    h: 110,
    floors: [mkF("b3", "3F", [["301", "大教室"], ["302", "大教室"]])],
  },
  {
    id: "b5",
    name: "5号館",
  ...
  },
  {
    ...
    h: 120,
    floors: [
      mkF("b6", "3F", [["301", "実習室"], ["302", "実習室"], ["303", "実習室"]]),
      mkF("b6", "2F", [["201", "シミュレーション室"], ["202", "実習室"], ["203", "実習室"]]),
  ...
  },
  {
    ...
    h: 110,
    floors: [
      mkF("b2", "4F", [["401", "マルチメディア教室"], "402", ["404", "ゼミ室"], ["405", "ゼミ室"], "406"]),
    ],
  },
  {
    id: "b4",
