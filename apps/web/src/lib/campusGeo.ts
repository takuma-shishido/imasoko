...
import { buildAreaGeo, featuresOf, type AreaShape, type AreaShapeKind } from "./areaGeo";

export type CampusShapeKind = AreaShapeKind;
export type CampusShape = AreaShape;
...
export const CAMPUS_GEO: CampusShape[] = geo.shapes;
