  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0 }}>
      ...
      >
        ...
        {v.publicRooms.map((pr, i) => (
          ...
          >
            <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
              ...
              <div style={{ fontFamily: "'Geist Mono',monospace", fontSize: 11, color: "#4d4d4d" }}>
                残り {pr.remaining}
              </div>
            </div>
            <div style={{ display: "flex", alignItems: "center", marginTop: 10 }}>
              <div style={{ fontSize: 12.5, color: "#888888", flex: 1 }}>
                {pr.members}人が参加中
              </div>
        ...
        {v.noPublicRooms && (
          <div
            style={{ textAlign: "center", padding: "56px 20px", color: "#888888", fontSize: 13 }}
          >
            いま公開されているルームはありません
