...
export function CampusSvg() {
  return (
    <svg width="800" height="640" viewBox="0 0 800 640" style={{ position: "absolute", left: 0, top: 0, display: "block" }}>
      <rect width="800" height="640" fill="#f5f5f5" />
      {/* 道路:北側(有明三丁目 東西)+ ブロック間(南北) */}
      <rect x="0" y="30" width="800" height="44" fill="#e8e8e8" />
      <line x1="0" y1="52" x2="800" y2="52" stroke="#c9c9c9" strokeWidth="1.5" strokeDasharray="14 10" />
      <rect x="480" y="30" width="64" height="610" fill="#e8e8e8" />
      <line x1="512" y1="30" x2="512" y2="640" stroke="#c9c9c9" strokeWidth="1.5" strokeDasharray="14 10" />
      ...
      {/* 5号館・4号館の連絡部 */}
      <rect x="618" y="284" width="32" height="58" fill="#ffffff" stroke="#a1a1a1" strokeWidth="1.5" />
