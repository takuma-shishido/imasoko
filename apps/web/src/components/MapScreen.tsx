  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0, position: "relative" }}>
      ...
      {v.viewerOnly && (
        ...
        >
          <span style={{ background: "#171717", color: "#fff", borderRadius: 9999, fontSize: 10, padding: "2px 8px" }}>
            閲覧のみ
          </span>
          <span style={{ color: "#4d4d4d", flex: 1 }}>自分の位置は共有されていません</span>
          <button
            onClick={v.sharePosAgain}
            style={{ background: "none", border: 0, color: "#0070f3", fontSize: 12, fontFamily: "inherit", cursor: "pointer" }}
          >
            位置を共有する
          </button>
        </div>
      ...
      <div style={{ borderTop: "1px solid #ebebeb", background: "#fff", position: "relative", zIndex: 5 }}>
        <div
          onClick={v.openMembers}
          className="hv-bg-soft"
          style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "7px 16px 4px", cursor: "pointer" }}
        >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(6,1fr)", padding: "4px 8px 10px", gap: 2 }}>
