  ...
  return (
    <Modal>
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <span style={{ width: 11, height: 11, background: "#0070f3", transform: "rotate(45deg)", flex: "none" }} />
      ...
      <input
        ...
        style={{ width: "100%", height: 40, border: "1px solid #ebebeb", borderRadius: 6, fontFamily: "inherit", fontSize: 13, padding: "0 10px", color: "#171717", boxSizing: "border-box" }}
      />
