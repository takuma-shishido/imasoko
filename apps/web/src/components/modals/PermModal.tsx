...
export function PermModal() {
  ...
  return (
    <Modal overlayStyle={{ alignItems: "flex-start", padding: 0, paddingTop: 70 }} cardStyle={{ padding: 18 }}>
      <div style={{ fontFamily: "'Geist Mono',monospace", fontSize: 9.5, letterSpacing: ".12em", color: "#888888", marginBottom: 8 }}>
        DEMO ・ ブラウザの許可ダイアログ
      </div>
      ...
      <div style={{ display: "flex", gap: 8, marginTop: 16 }}>
        ...
        <button
          onClick={v.permAllow}
          style={{ flex: 1, height: 38, borderRadius: 9999, border: 0, background: "#171717", color: "#fff", fontSize: 13, fontWeight: 500, fontFamily: "inherit", cursor: "pointer" }}
        >
          許可
        </button>
      </div>
